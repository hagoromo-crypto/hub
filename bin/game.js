...
import Script3 from "../c1da72b5-fbda-4ba5-ad96-a921a3ef0d3b/src/item"
import Script4 from "../3f3fe65b-c648-44bc-8781-c2a40bc95bb4/src/item"
...
const transform3 = new Transform({
  position: new Vector3(14.843414306640625, 1, 11.883535385131836),
...
const transform4 = new Transform({
  position: new Vector3(11.889105796813965, 1, 14.405325889587402),
...
const transform5 = new Transform({
  ...
  scale: new Vector3(0.5100004076957703, 0.5, 0.5000003576278687)
})
...
const transform20 = new Transform({
  position: new Vector3(15.85056209564209, 0, 0.9735644459724426),
  rotation: new Quaternion(-4.168405305138062e-16, 0.7071068286895752, -8.429368847373553e-8, 0.7071067690849304),
  scale: new Vector3(1.1998339891433716, 1, 1.0000001192092896)
})
squareSignpost.addComponentOrReplace(transform20)
...
const transform21 = new Transform({
  ...
  rotation: new Quaternion(-3.320320660600627e-15, -0.9569404125213623, 1.1407617961367578e-7, 0.29028457403182983),
  scale: new Vector3(1.0000005960464478, 1, 1.0000005960464478)
})
signpostRoot.addComponentOrReplace(transform21)
...
script3.spawn(squareSignpost, {"text":"Ethermon\nHouse","fontSize":29}, createChannel(channelId, squareSignpost, channelBus))
script4.spawn(signpostRoot, {"text":"Ethermon\nHub","fontSize":30}, createChannel(channelId, signpostRoot, channelBus))